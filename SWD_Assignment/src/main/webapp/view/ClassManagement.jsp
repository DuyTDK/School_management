...
<body>
	<div class="wrapper" style="background-color: #8c8c90">
		<div class="logo">
			<a href="#"><img src="../image/student-management-8.png"
				style="max-width: 80%; max-height: 90px; margin-top: 5%"></a>
		</div>
		<div class="user">
			<div class="welcome">
				<span>Hello user
					<p>mr A</p>
				</span> <img src="../surtr.jpg" class="user-pic" onclick="toggleMenu()">
			</div>
						...
						<tbody>
							<c:forEach items="${classes}" var="classes">
								<tr>
									...
									<td><a href = "UpdateClass?classId=${classes.classId} "> <i class="fa fa-edit"></i></a></td>
								</tr>
							</c:forEach>
							<!-- <tr>
